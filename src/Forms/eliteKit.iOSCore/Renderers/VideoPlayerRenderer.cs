...
namespace eliteKit.iOSCore.Renderers
{
    ...
    /// </summary>
    internal class VideoPlayerRenderer : ViewRenderer<VideoPlayer, UIView>, IVideoPlayerRenderer
    {
        #region Fields
        ...
        public override void ObserveValue(NSString keyPath, NSObject ofObject, NSDictionary change, IntPtr context)
        {
            ...
            if (string.Equals(keyPath, "status"))
            {
                if (videoPlayer.Status == AVPlayerStatus.ReadyToPlay && videoPlayer.CurrentItem.Status == AVPlayerItemStatus.ReadyToPlay)
                {
                    ...
                    Element.SetValue(VideoPlayer.VideoDurationPropertyKey, TimeSpan.FromSeconds(_playerControl.Player.CurrentItem.Duration.Seconds));
        ...
        private void UpdateFillMode()
        {
            ...
            {
                case eliteFillMode.Resize:
                    _playerControl.VideoGravity = AVLayerVideoGravity.Resize;
                    break;
                case eliteFillMode.ResizeAspect:
        ...
        private EventArgsVideoPlayerStateChanged CreateVideoPlayerStateChangedEventArgs(elitePlayerState state)
        {
            ...
            return new EventArgsVideoPlayerStateChanged(videoPlayerEventArgs, state);
        }
        ...
        private EventArgsVideoPlayerError CreateVideoPlayerErrorEventArgs()
        {
            ...
            if (error != null)
            {
                ...
                var videoPlayerEventArgs = CreateVideoPlayerEventArgs();
                return new EventArgsVideoPlayerError(videoPlayerEventArgs, errorStatus, error);
            }
