...
{
    /// <summary>
    /// <see cref="T:Xamarin.Forms.VideoPlayer.VideoSource"/> that loads a video from a <see cref="T:System.IO.Stream"/>.
    /// </summary>
    internal sealed class StreamVideoSource : VideoSource
    {
        /// <summary>
        ...
        /// <summary>
        /// Backing store for the <see cref="P:Xamarin.Forms.VideoPlayer.StreamVideoSource.Stream"/> property.
        /// </summary>
