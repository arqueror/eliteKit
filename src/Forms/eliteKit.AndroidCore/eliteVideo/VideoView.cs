...
namespace eliteKit.AndroidCore.eliteVideo
{
    ...
    /// </summary>
    [Register("Xamarin.Forms.VideoPlayer.Android.Widget.VideoView")]
    internal class VideoView : global::Android.Widget.VideoView
    {
        #region Properties
        ...
        /// The fill mode.
        /// </value>
        public eliteFillMode FillMode { get; set; }
